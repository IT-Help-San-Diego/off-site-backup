...
func TestEnrichViewDataMetricsSnapshotPath_CB15(t *testing.T) {
        ...
        func() {
                defer func() {
                        if r := recover(); r != nil {
                                t.Logf("recovered panic in snapshot path (nil queries): %v", r)
                        }
                }()
...
func TestEnrichViewDataMetricsNonSnapshotPath_CB15(t *testing.T) {
        ...
        func() {
                defer func() {
                        if r := recover(); r != nil {
                                t.Logf("recovered panic in non-snapshot path (nil queries): %v", r)
                        }
                }()
...
func TestEnrichViewDataMetricsSnapshotNoAnalysisID_CB15(t *testing.T) {
        ...
        func() {
                defer func() {
                        if r := recover(); r != nil {
                                t.Logf("recovered panic (snapshot, id=0): %v", r)
                        }
                }()
...
func TestMissionCriticalDomainsFromBaseURL_CB15(t *testing.T) {
        ...
        t.Run("path included in host", func(t *testing.T) {
                ...
                if !hostFound {
                        t.Logf("domains = %v (path handling depends on implementation)", domains)
                }
        })
...
func TestBuildSuggestedConfigNilQueries_CB15(t *testing.T) {
        func() {
                defer func() {
                        if r := recover(); r != nil {
                                t.Logf("recovered panic with nil queries: %v", r)
                        }
                }()
