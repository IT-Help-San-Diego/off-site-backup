...
type MockDNSClient struct {
        ...
        probeResults   map[string]struct{ exists bool; cname string }
...
func NewMockDNSClient() *MockDNSClient {
        return &MockDNSClient{
                ...
                probeResults:   make(map[string]struct{ exists bool; cname string }),
...
func (m *MockDNSClient) AddProbeResult(domain string, exists bool, cname string) {
        m.mu.Lock()
        defer m.mu.Unlock()
        m.probeResults[strings.ToLower(domain)] = struct{ exists bool; cname string }{exists, cname}
}
