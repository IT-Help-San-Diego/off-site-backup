...
func TestTryFetchLLMSFullTxt_Success(t *testing.T) {
	...
	ok := scanner.tryFetchLLMSFullTxt(context.Background(), ts.URL+"/llms-full.txt")
	if !ok {
...
func TestFetchLLMSTxt_Found(t *testing.T) {
	...
	var evidence []Evidence
	found, url, fields := scanner.fetchLLMSTxt(context.Background(), strings.TrimPrefix(ts.URL, "http://"), &evidence)
	if !found {
...
func TestFetchLLMSTxt_NotFound(t *testing.T) {
	...
	var evidence []Evidence
	found, _, _ := scanner.fetchLLMSTxt(context.Background(), strings.TrimPrefix(ts.URL, "http://"), &evidence)
	if found {
...
func TestFetchLLMSFullTxt_Found(t *testing.T) {
	...
	var evidence []Evidence
	found, fullURL := scanner.fetchLLMSFullTxt(context.Background(), strings.TrimPrefix(ts.URL, "http://"), &evidence)
	if !found {
...
func TestFetchLLMSFullTxt_NotFound(t *testing.T) {
	...
	var evidence []Evidence
	found, _ := scanner.fetchLLMSFullTxt(context.Background(), strings.TrimPrefix(ts.URL, "http://"), &evidence)
	if found {
